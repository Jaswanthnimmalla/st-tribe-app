...
class ProfileUseCase {
  ...
  Future<dynamic> handleUpdateMyProfile(FormData data) async {
    ...
    Future<dynamic> handleStCoinsTransactionHistory(Map<String,dynamic> query) async {
    try {
      return await _profileRepository.getStCoinsTransactionHistory(query);
    } catch (e) {
      rethrow;
    }
  }
    ...
    Future<dynamic> handleDeleteUserProfile() async {
    try {
      return await _profileRepository.deleteUserProfile();
    } catch (e) {
      rethrow;
    }
  }
