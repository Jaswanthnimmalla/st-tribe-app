...
class ProfileRepository {
  ...
  Future<dynamic> getStCoinsTransactionHistory(Map<String,dynamic> query) async {
    try {
      return _apiClient.get('${Endpoints.profile}/stcoins?sort=-createdAt',queryParameters: query);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<dynamic> deleteUserProfile() async {
    try {
      return _apiClient.delete("/users/me");
    } catch (e) {
      rethrow;
    }
  }
